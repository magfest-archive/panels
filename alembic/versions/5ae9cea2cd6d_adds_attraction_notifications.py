...
attraction_event_table = table(
    ...
    sa.Column('id', sideboard.lib.sa.UUID()),
    sa.Column('attraction_id', sideboard.lib.sa.UUID()),
    sa.Column('attraction_feature_id', sideboard.lib.sa.UUID()),
)
...
def upgrade():
    if is_sqlite:
        ...
        with op.batch_alter_table('attraction_event', reflect_kwargs=sqlite_reflect_kwargs) as batch_op:
            batch_op.add_column(sa.Column('attraction_id', sideboard.lib.sa.UUID(), nullable=True))
        ...
        op.add_column('attraction_event', sa.Column('attraction_id', sideboard.lib.sa.UUID(), nullable=True))

        op.add_column('attraction_signup', sa.Column('attraction_id', sideboard.lib.sa.UUID(), nullable=True))
    ...
    if is_sqlite:
        ...
        with op.batch_alter_table('attraction_signup', reflect_kwargs=sqlite_reflect_kwargs) as batch_op:
            ...
            batch_op.alter_column('checkin_time', existing_type=sideboard.lib.sa.UTCDateTime(), nullable=False)
            batch_op.alter_column('signup_time', existing_type=sideboard.lib.sa.UTCDateTime(), server_default=None)
        ...
        op.alter_column('attraction_signup', 'checkin_time', existing_type=sideboard.lib.sa.UTCDateTime(), nullable=False)
        op.alter_column('attraction_signup', 'signup_time', existing_type=sideboard.lib.sa.UTCDateTime(), server_default=None)
...
def downgrade():
    ...
    op.alter_column('attraction_signup', 'signup_time', existing_type=sideboard.lib.sa.UTCDateTime(), server_default=text(utcnow_server_default))
    op.alter_column('attraction_signup', 'checkin_time', existing_type=sideboard.lib.sa.UTCDateTime(), nullable=True)

...
def upgrade():
    ...
    sa.Column('poc_id', postgresql.UUID(), nullable=True),
    sa.Column('name', sa.Unicode(), server_default='', nullable=False),
    ...
    sa.Column('applied', sa.DateTime(), server_default=sa.text("timezone('utc', current_timestamp)"), nullable=False),
    ...
    sa.Column('attendee_id', postgresql.UUID(), nullable=True),

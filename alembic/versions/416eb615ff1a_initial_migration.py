...
def upgrade():
    ...
    sa.Column('poc_id', sideboard.lib.sa.UUID(), nullable=True),
    sa.Column('name', sa.Unicode(), server_default='', nullable=False),
    ...
    sa.Column('applied', sideboard.lib.sa.UTCDateTime(), server_default=sa.text(utcnow_server_default), nullable=False),
